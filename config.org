...
#+begin_src emacs-lisp
  ...
  (use-package sly
        :ensure t
        :config (setf inferior-lisp-program "/usr/local/bin/sbcl"))
...
#+begin_src emacs-lisp
  (use-package aidermacs
      :ensure (aidermacs :type git
                                :host github
                                :protocol ssh
                                :repo "MatthewZMD/aidermacs")

    :bind (("C-c a" . aidermacs-transient-menu))
    :config (setenv "GEMINI_API_KEY" "AIzaSyCqQ8aIgDMbftlmuaUFwSG4WNUcovqrjdg")
    (setf aidermacs-default-chat-mode 'architect)
    (setf aidermacs-default-model "gemini"))
#+end_src

#+RESULTS:
: [nil 26722 29080 632364 nil elpaca-process-queues nil nil 514000 nil]
